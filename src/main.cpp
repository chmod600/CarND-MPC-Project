      ...
      if (s != "") {
        ...
        if (event == "telemetry") {
          ...
          */
          ...
          // Found using turning radius method discussed in the chapter
          double Lf = 2.67;
          ...
          doulble poly_inc = 2.5;
          int num_points = 25;
          for(unsinged int i = 1; i < num_points; ++i) {
            next_x_vals.push_back(poly_inc * i);
            next_y_vals.push_back(polyval(coeffs, (poly_inc * i)))
          }
